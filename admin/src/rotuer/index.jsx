...
import FeaturesProperties from "../pages/setting/FeaturesProperties.jsx";
import OurProperties from "../pages/setting/OurProperties.jsx";
import Gallery from "../pages/setting/Gallery.jsx";
import Review from "../pages/setting/Review.jsx";
...
const AppRouter = () => {
  return (
    <Routes>
      ...
      <Route path="/setting/featured-properties-gallery-list" element={<FeaturesProperties />} />

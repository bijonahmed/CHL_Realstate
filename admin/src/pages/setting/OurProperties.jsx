...
const OurProperties = () => {
  ...
  const getSlidermages = async () => {
    try {
      const response = await axios.get(`/setting/getsOurProperties`, {
        headers: {
  ...
  const handleDelete = async (id) => {
    ...
    if (result.isConfirmed) {
      try {
        ...
        const response = await axios.get(`/setting/delteOurProperties`, {
          headers: {
            Authorization: `Bearer ${token}`,
          },
          params: { id: id },
  ...
  return (
    <>
      <Helmet>
        <title>Our Properties List</title>
      </Helmet>
          ...
          <div className="page-wrapper">
            <div className="page-content">
              <div className="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                <div className="breadcrumb-title pe-3">Our Properties </div>
                <div className="ps-3">

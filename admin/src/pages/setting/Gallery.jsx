...
const Gallery = () => {
  ...
  const getSlidermages = async () => {
    try {
      const response = await axios.get(`/setting/getsGallery`, {
        headers: {
  ...
  const handleDelete = async (id) => {
    ...
    if (result.isConfirmed) {
      try {
        ...
        const response = await axios.get(`/setting/delteGallery`, {
          headers: {
            Authorization: `Bearer ${token}`,
          },
          params: { id: id },
          ...
          <div className="page-wrapper">
            <div className="page-content">
              <div className="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                <div className="breadcrumb-title pe-3">Gallery List </div>
                <div className="ps-3">

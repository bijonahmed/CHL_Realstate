          ...
          <div className="page-wrapper">
            <div className="page-content">
              <div className="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                <div className="breadcrumb-title pe-3">Review List</div>
                <div className="ps-3">
                        ...
                        <div className="col-6 mb-3" key={index}>
                          <div className="card">
                            <div className="card-body text-center">
                              <span className="card-text"><b>{sdata.name}</b></span><br/>
                               <span className="card-text">{sdata.designation}</span><br/>
                                <span className="card-text" style={{ color: 'green'}}>{sdata.message}</span>
                              <br />
                              <i

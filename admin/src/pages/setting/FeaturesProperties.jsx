...
const FeaturesProperties = () => {
  ...
  const [formData, setFormData] = useState({
    room_id: "",
    title_name: "Features Properties",
    status: 1,
    sliderImage: null,
  });
  ...
  const getSlidermages = async () => {
    try {
      const response = await axios.get(`/setting/getsFeaturesProperSliders`, {
        headers: {
  ...
  const handleDelete = async (id) => {
    ...
    if (result.isConfirmed) {
      try {
        ...
        const response = await axios.get(`/setting/delteFeaturesProperSlider`, {
          headers: {
            Authorization: `Bearer ${token}`,
          },
          params: { id: id },
  ...
  const handleSubmit = async (formData) => {
    try {
      ...
      const response = await axios.post(
        "/setting/featuresPropertiesSlider",
        formPayload,
        {
          headers: {
            Authorization: `Bearer ${token}`,
          ...
          <div className="page-wrapper">
            <div className="page-content">
              <div className="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                <div className="breadcrumb-title pe-3">Features Properties</div>
                <div className="ps-3">

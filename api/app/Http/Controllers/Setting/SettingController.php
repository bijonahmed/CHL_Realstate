...
class SettingController extends Controller
{
    ...
    public function getsOurProperties()
    {
        try {
            $allImages = OurProperties::where('status', 1)->get();
            $data = [];
    ...
    public function getPropertiesLocation()
    {
        try {
            $allImages = OurProperties::where('status', 1)->get();
            $data = [];
    ...
    {
        try {
            $allImages = Gallery::where('status', 1)->get();
            $data = [];
            foreach ($allImages as $key => $v) {
    ...
    public function getsFeaturesProperSliders()
    {
        try {
            $allImages = FeaturePropertiesSlider::where('status', 1)->get();
            $data = [];
            foreach ($allImages as $key => $v) {
    ...
    public function delteFeaturesProperSlider(Request $request)
    {
        // dd($request->all());
        try {
            $row = FeaturePropertiesSlider::where('id', $request->id)->first();
            if ($row) {
    ...
    public function delteGallery(Request $request)
    {
        // dd($request->all());
        try {
            $row = Gallery::where('id', $request->id)->first();
            if ($row) {
    ...
    public function delteOurProperties(Request $request)
    {
        // dd($request->all());
        try {
            $row = OurProperties::where('id', $request->id)->first();
            if ($row) {
    ...
    public function servicedataSave(Request $request)
    {
        ...
        $validator = Validator::make($request->all(), [
            ...
            'designation.required'   => 'Designation is requried.',
            'message.required'   => 'Message is requried.',
            'status.required'       => 'Please select te status.',
        ]);
    ...
    public function ourPropertiesSave(Request $request)
    {
        // dd($request->all());
        $validator = Validator::make($request->all(), [
            'title_name'      => 'required',
        ...
        if (empty($request->id)) {
            OurProperties::create($data);
        } else {
            OurProperties::where('id', $request->id)->update($data);
        }
    ...
    public function featuresPropertiesSlider(Request $request)
    {
        // dd($request->all());
        $validator = Validator::make($request->all(), [
            'title_name'      => 'required',
        ...
        if (empty($request->id)) {
            FeaturePropertiesSlider::create($data);
        } else {
            FeaturePropertiesSlider::where('id', $request->id)->update($data);
        }

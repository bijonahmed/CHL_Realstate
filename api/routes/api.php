...
Route::group([
    ...
    Route::get('/getFeaturesProSliders', [PublicController::class, 'getFeaturesProSliders']);
    Route::get('/getGalleryData', [PublicController::class, 'getGalleryData']);
    Route::get('getsOurProperties', [PublicController::class, 'getsOurProperties']);
...
Route::middleware(['auth:api', CheckUserStatus::class])->group(function () {
    ...
    Route::group([
        ...
        Route::get('delteGallery', [SettingController::class, 'delteGallery']);
        Route::get('delteOurProperties', [SettingController::class, 'delteOurProperties']);
        Route::get('delteFeaturesProperSlider', [SettingController::class, 'delteFeaturesProperSlider']);
        ...
        Route::post('saveGallery', [SettingController::class, 'saveGallery']);
        Route::post('featuresPropertiesSlider', [SettingController::class, 'featuresPropertiesSlider']);
        Route::post('ourPropertiesSave', [SettingController::class, 'ourPropertiesSave']);
